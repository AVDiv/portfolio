  ...
  capabilities={[
    {
      ...
      description: "Analyze news articles as they are published for bias"
    },
    {
  ...
  architectureDetails={[
    {
      ...
      description: "Distributed system with independent services for collection, processing, and serving"
    },
    {
    ...
    {
      title: "Content Filtration",
      description: "Faiss-powered similarity search for efficient article content block filtration"
    },
    {
      title: "News Clustering",
      description: "Use of Neo4j and custom algorithms for clustering related articles based on content"
    },
    {
      title: "Workflow Orchestration",
      description: "Prefect-based orchestration for managing complex data workflows for news aggregation, analysis, and clustering, etc."
    }
  ]}
  techStack={[
    {
